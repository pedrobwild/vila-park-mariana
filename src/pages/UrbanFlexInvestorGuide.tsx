...
// FAQ do Guia do Comprador — perguntas gerais, importadas de src/data/faq.ts
// (fonte única para evitar duplicação com o Guia do Investidor).
const faqItems = generalFaq;
